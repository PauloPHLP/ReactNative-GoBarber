...
const CreateAppointment: React.FC = () => {
  ...
  const handleCreateAppointment = useCallback(async () => {
    try {
      ...
      Alert.alert(
        'Error!',
        'An error has occurred while creating a new appointment. Try again later.',
      );
    }
  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <CreateAppointmentButtton onPress={handleCreateAppointment}>
